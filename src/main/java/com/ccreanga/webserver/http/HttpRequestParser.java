...
public class HttpRequestParser {
    ...
    public static HttpRequestLine consumeRequestMethod(InputStream in, Configuration configuration) throws IOException, InvalidMessageException {
        String line;
...
//                configuration.getRequestMaxLineLength());
        ...
        while (((line = IOUtil.readLine(in,configuration.getRequestMaxLineLength())) == null) || (line.isEmpty())) ;
    ...
    public static HTTPHeaders consumeHeaders(InputStream in, Configuration configuration) throws IOException, InvalidMessageException {
        HTTPHeaders headers = new HTTPHeaders();
        //read the HTTPHeaders.
        String previousHeader = "";
        String line;
        while ((line = IOUtil.readLine(in,configuration.getRequestMaxLineLength())) != null) {
            if (line.isEmpty()) {
                break;
            }
...
//        try {
            ...
            HttpRequestLine httpRequestLine = HttpRequestParser.consumeRequestMethod(in,configuration);
            HTTPHeaders httpHeaders = HttpRequestParser.consumeHeaders(in,configuration);
...
//        }
        ...
        boolean chunk = "chunked".equals(httpHeaders.getHeader(TRANSFER_ENCODING));
        long length = -1;
        ...
        return new HttpRequestMessage(httpRequestLine, httpHeaders, in, chunk, length);
