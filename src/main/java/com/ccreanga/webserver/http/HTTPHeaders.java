...
public class HTTPHeaders {
    ...
    public static String acceptAuthorization = "Authorization";
    ...
    public static String xRequestedFor = "X-Requested-With";
    public static String xDoNotTrack = "X-Do-Not-Track";
    public static String dnt = "DNT";

    public static String acceptRange = "Accept-Ranges";
    ...
    public static String proxyAuthenticate = "Proxy-Authenticate";
    public static String refresh = "Refresh";
    public static String retryAfter = "Retry-After";
    ...
    public static String xFrameOptions = "X-Frame-Options";
    public static String xXssProtection = "X-XSS-Protection";
    public static String xContentType = "X-Content-Type-Options";
